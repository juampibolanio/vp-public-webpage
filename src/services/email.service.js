 ...
 * ---------------------
 * Server-side utility responsible for sending contact emails
 * generated from the website contact form.
 *
 * Responsibilities:
 * - Validate basic email format.
 * - Configure and use an SMTP transporter.
 * - Send formatted HTML emails with contact data.
 *
 * Notes:
 * - Uses Nodemailer with Gmail as the transport service.
 * - SMTP credentials are provided via environment variables.
 * - Intended to run in a server-only context.
 */

import nodemailer from 'nodemailer';

/**
 * Send a contact email using form submission data.
 *
 ...
 * @throws {Error} If the email format is invalid or sending fails.
 */
